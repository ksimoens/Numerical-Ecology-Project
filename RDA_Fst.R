...
plotRDA(df.plot.s1,Evalues,variables,scale.fac,"RDA_Fst_s1_country.png",3,1)
...
plotRDA(df.plot.s2,Evalues,variables.s2,scale.fac.s2,"RDA_Fst_s2_country.png",3,0)
...
p %>% ggsave("resid_PCA_Fst.png",.,device='png',width=15,height=10,units='cm')
...
p %>% ggsave("rdacca_sep_Fst.png",.,device='png',width=15,height=7.5,units='cm')

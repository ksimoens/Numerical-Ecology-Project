...
p <- ggplot() + 
		# geom_polygon: aes(follow the whole polygon)
		# fill="" for in scale_fill_manual: inside aes
		...
		# no legend name:"", breaks="see fill in geom_polygon", value=fill colour
		...
		# no minor gridline; no xlabel; legend on top; legend text size
